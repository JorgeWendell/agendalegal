...
const user = process.env.POSTGRES_USER ?? "agendalegal";
const password = process.env.POSTGRES_PASSWORD ?? "";
const database = process.env.POSTGRES_DB ?? "agendalegal";
...
try {
  ...
  console.log("Schema aplicado. Crie a conta no primeiro acesso.");
} catch (error) {
